...
class SparseMoEPolicy(nn.Module):
    def __init__(self, envs, activation_name):
        ...
        self.moe = SparseMoE(o_dim, FEATURE_NUM, 3, top_k=1)

        self.mean_net = nn.Sequential(nn.Linear(FEATURE_NUM, a_dim))
